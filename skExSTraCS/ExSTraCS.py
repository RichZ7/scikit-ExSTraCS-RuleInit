...
class ExSTraCS(BaseEstimator,ClassifierMixin):
    def __init__(self,learning_iterations=100000,N=1000,nu=1,chi=0.8,mu=0.04,theta_GA=25,theta_del=20,theta_sub=20,
                 ...
                 rule_compaction='QRF',reboot_filename=None, useRF_Init= False, discrete_attribute_limit=10,specified_attributes=np.array([]),
    ...
    def fit(self, X, y):
        ...
        if self.learning_iterations == self.iterationCount and self.reboot_filename != None and self.useRF_Init != True:
